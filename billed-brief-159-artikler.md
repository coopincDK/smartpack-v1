# Billed-brief: 159 artikler uden billede

Kort udgave: **159 artikler mangler et billede. Der skal laves ét billede til hver. 159 filer i alt.**

Vi har 246 artikler i viden-sektionen. 87 har et billede, 159 har ikke. De 87 bruger alle ét enkelt
billede øverst i artiklen, og det er den samme opskrift her: ét billede pr. artikel, ikke flere.
Billeder inde i teksten kan vi altid lægge til senere, men de flytter ikke noget lige nu.
...
Nummereringen fortsætter fra de 20 billeder vi allerede har, så de nye hedder 21 til 179.
...
| 26 | `26-ordreflow-fra-skaerm-til-pakke.jpg` | Dataflow i e-handel, fra ordre til forsendelse trin for trin | Split-motiv i ét billede: venstre side en telefon med en ordrebekræftelse, højre side den færdige pakke på et pakkebord. | Telefon med ordrebekræftelse ved siden af en færdig pakke |
...
| 34 | `34-systemer-forbundet-kabelboejle.jpg` | Integrationer forklaret: sådan taler dine systemer sammen | Nærbillede af pæne kabler i en bøjle der løber fra et kontor ud mod lagerhallen. | Kabler der løber fra kontor ud i lagerhallen |
...
| 55 | `55-besked-sendt-mellem-systemer.jpg` | Webhooks forklaret: realtidsnotifikationer til dit lagersystem | Nærbillede af to små servere på en reolhylde med et enkelt patchkabel imellem. | To små servere forbundet med et patchkabel |
...
| 58 | `58-lagerhal-og-kontor-side-om-side.jpg` | WMS vs. ERP: hvad er forskellen, og hvornår skal du have begge? | Bred optagelse hvor lagerhallen fylder venstre halvdel og et lille kontor med skærme højre halvdel. | Lagerhal og kontor side om side |
...
### Fundamentals (19 billeder)

| Nr | Filnavn | Artikel | Prompt | Alt-tekst |
|---|---|---|---|---|
| 86 | `86-abc-zoner-markeret-paa-gulv.jpg` | ABC-analyse af sortiment: find dine vigtigste varer | Lagergulv med tre farvede zonemarkeringer i afstand fra pakkeområdet, reoler på hver side. | Lagergulv med tre farvede zonemarkeringer |
| 87 | `87-cross-docking-port-til-port.jpg` | Hvad er cross-docking? Når varer ikke skal på lager | Bred hal med en indgående palle på vej direkte over gulvet mod en udgående port, ingen reoler imellem. | Palle køres direkte fra indgående til udgående port |
...
| 90 | `90-fifo-aeldste-vare-forrest.jpg` | Hvad er FIFO? Forklaring og eksempler fra lageret | Reolplads hvor de forreste kasser er tydeligt ældre og stovede, de bagerste nye og rene. | Reolplads med ældre kasser forrest og nye bagerst |
...
| 93 | `93-vareflow-gennem-hallen.jpg` | Hvad er lagerflow? Sådan bevæger varer sig på lageret | Bred optagelse af en lagerhal hvor gulvmarkeringer viser en vej fra modtagelse over reoler til pakkeområde. | Lagerhal med gulvmarkeringer der viser vareflowet |
...
| 97 | `97-hylde-naesten-tom-bestilling.jpg` | Hvad er reorder point? Beregning og eksempler | Reolplads med kun to varer tilbage og en tydelig tom markering ved siden af. | Reolplads med kun to varer tilbage |
...
| 99 | `99-ekstra-paller-paa-hoejlager.jpg` | Hvad er sikkerhedslager? Formel, beregning og hvornår det er for meget | Højlagerreol hvor de overste pladser er fyldt med reservepaller af samme vare. | Højlagerreol med reservepaller øverst |
...
| 103 | `103-to-zoner-adskilt-af-markering.jpg` | Hvad er zone picking? Sådan opdeler du lageret for færre fejl | Lagergulv delt af en tydelig gul markering med en plukker på hver side. | Lagergulv delt i to zoner med en plukker i hver |
...
| 129 | `129-retur-stabel-vokser.jpg` | Hvad koster en retur? De rigtige tal | Stabel af uåbnede returpakker der er ved at vokse ud over bordet i et returområde. | Voksende stabel af uåbnede returpakker |
...
| 144 | `144-fem-tal-paa-tavle.jpg` | De fem nøgletal du kan begynde at følge i næste uge | Whiteboard i lagerhallen med fem tomme felter tegnet op til nøgletal, tusch liggende i rillen. | Whiteboard med fem felter til nøgletal |
...
| 173 | `173-fra-koekkenbord-til-lagerhal.jpg` | Den typiske lager-evolution for en voksende webshop | To motiver i samme billede: et lille bord med få pakker i forgrunden og en stor lagerhal bagved. | Lille pakkebord i forgrunden og stor lagerhal bagved |
...
## De 14 der egentlig er diagrammer

Disse artikler forklarer et forløb eller en formel. Et foto kan godt illustrere dem, og promptene
ovenfor virker, men de ville være bedre som en simpel tegning med kasser og pile. Den slags skal
ikke laves med billedgenerering, for så bliver teksten forkert. Den laves i Canva eller Figma,
hvor teksten er rigtig tekst. Samme filnavn og samme nummer, bare en anden vej til filen:

- `26-ordreflow-fra-skaerm-til-pakke.jpg` - Dataflow i e-handel, fra ordre til forsendelse trin for trin
- `34-systemer-forbundet-kabelboejle.jpg` - Integrationer forklaret: sådan taler dine systemer sammen
- `55-besked-sendt-mellem-systemer.jpg` - Webhooks forklaret: realtidsnotifikationer til dit lagersystem
- `58-lagerhal-og-kontor-side-om-side.jpg` - WMS vs. ERP: hvad er forskellen, og hvornår skal du have begge?
- `86-abc-zoner-markeret-paa-gulv.jpg` - ABC-analyse af sortiment: find dine vigtigste varer
- `87-cross-docking-port-til-port.jpg` - Hvad er cross-docking? Når varer ikke skal på lager
- `90-fifo-aeldste-vare-forrest.jpg` - Hvad er FIFO? Forklaring og eksempler fra lageret
- `93-vareflow-gennem-hallen.jpg` - Hvad er lagerflow? Sådan bevæger varer sig på lageret
- `97-hylde-naesten-tom-bestilling.jpg` - Hvad er reorder point? Beregning og eksempler
- `99-ekstra-paller-paa-hoejlager.jpg` - Hvad er sikkerhedslager? Formel, beregning og hvornår det er for meget
- `103-to-zoner-adskilt-af-markering.jpg` - Hvad er zone picking? Sådan opdeler du lageret for færre fejl
- `129-retur-stabel-vokser.jpg` - Hvad koster en retur? De rigtige tal
- `144-fem-tal-paa-tavle.jpg` - De fem nøgletal du kan begynde at følge i næste uge
- `173-fra-koekkenbord-til-lagerhal.jpg` - Den typiske lager-evolution for en voksende webshop

## Hvad der sker bagefter

Når filerne ligger i `assets/viden/artikel_billeder/` sætter jeg dem selv ind i de 159 artikler
