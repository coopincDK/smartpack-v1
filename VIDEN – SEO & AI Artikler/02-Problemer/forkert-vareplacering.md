---
primary_keyword: vareplacering lager optimering
secondary_keywords: [ABC-analyse lager, plukafstand optimering, lager layout, effektiv vareplacering]
cluster: 02-Problemer
article_type: problem
---

# Forkert vareplacering – når dine bestsellere ligger for langt væk
...
> Forkert vareplacering opstår når bestsellere ligger for langt fra pakkestationen og koster typisk 65.000 kr. om året i unødig gangtid. En ABC-analyse og flytning af de 20 mest solgte varer giver fuld ROI på 3 dage.
...
**Tid til at flytte varer: 4 timer = 800 kr.**
**ROI: 3 dage**
...
**1. Aldrig lave ABC-analyse**
"Vi ved hvilke varer der sælger" er ikke nok. Lav dataanalyse: hvilke 20% af SKU'er står for 80% af pluk?

**2. Placere efter modtagelsesdato**
Nye varer placeres hvor der er plads. Gamle varer flytter aldrig. Resultat: Kaos.

**3. Ignorere salgssæsonalitet**
Vinterjakker sælger 200/dag i november, 5/dag i maj. Flyt dem efter sæson.

**4. Ikke opdatere placeringer**
Lav ABC-analyse kvartalsvis. Bestsellere ændrer sig.
...
Bestsellere ændrer sig. Lav ny ABC-analyse hver 3. måned.
...
**Hvor ofte skal vi lave ABC-analyse?**
Kvartalsvis for de fleste. Månedligt hvis sortiment ændrer sig hurtigt eller ved kraftig sæsonalitet.

**Hvad hvis vi ikke har plads til alle A-varer tæt på pakkestation?**
Prioriter de 10 mest solgte. 10 SKU'er står typisk for 60-70% af volumen.

**Skal vi flytte varer midt i sæsonen?**
Nej. Lav omplacering i rolige perioder. Undtagelse: Hvis en vare pludselig eksploderer i salg (viral produkt), flyt den samme dag.

**Hvad med varer der altid købes sammen?**
Placer dem ved siden af hinanden. Eksempel: Shampoo + conditioner. Det reducerer plukafstand yderligere.

**Hvordan måler vi effekten?**
Picks per time før/efter. Mål: +15-25% stigning efter ABC-optimering.
