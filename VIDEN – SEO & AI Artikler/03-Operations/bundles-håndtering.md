...
Bundle-håndtering registrerer sæt-produkter via styklister (BOM) og plukker komponenterne individuelt. Den vigtigste regel: modtag altid komponenterne separat – aldrig bundle-SKU'et direkte.
...
- [Problem: Forkert lagerantal og oversalg](/viden/problemer/forkert-lagerantal)
