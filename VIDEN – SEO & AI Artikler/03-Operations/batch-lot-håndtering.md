...
LOT/batch-håndtering sporer produktionspartier via FIFO eller FEFO fra modtagelse til afsendelse. Formålet er at sikre korrekt rotation, forhindre udgåede varer og muliggøre en præcis recall frem for total tilbagekaldelse.
...
- [Problem: Udgåede varer på lager](/viden/problemer/udloebsvarer-paa-lager)
