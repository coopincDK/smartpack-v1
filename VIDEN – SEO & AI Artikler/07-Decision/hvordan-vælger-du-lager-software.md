...
> Test aldrig WMS på demo-data – kør 2 uger med reelle ordrer. Tjek specifikt: integration med din fragtaftale (ikke bare fragtleverandøren), support-responstid uden for salgsfasen, og hvad der sker ved 3× dit volumen. Det er de tre ting der oftest går galt.
...
- [Samlede lageromkostninger](../05-Economics/lageromkostninger-beregning.md)
