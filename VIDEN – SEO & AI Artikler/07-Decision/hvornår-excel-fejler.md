...
> Excel fejler som lagersystem over 50 ordrer/dag med varianter, ved 2+ samtidige medarbejdere eller ved sæsontoppe. Skift til WMS når din månedlige fejlomkostning overstiger WMS-abonnementet – det sker typisk ved 50+ ordrer/dag.
...
- [Hvornår er Shopify's lagerfunktion ikke nok?](hvornår-shopify-ikke-er-nok.md)
- [Hvad koster en plukkefejl?](../05-Economics/plukkefejl-koster-penge.md)
- [WMS vs. manuel drift](wms-vs-manuel-drift.md)
