...
(function () {
  ...
  function injectFooter() {
    ...
    var html = [
      ...
      '        <a href="' + url('/kontakt') + '" class="footer__cta-btn">Lad os kigge p&aring; det sammen &rarr;</a>',
      ...
      '          <ul>',
      '            <li><a href="' + url('/funktioner') + '">Funktioner</a></li>',
      '            <li><a href="' + url('/integrationer') + '">Integrationer</a></li>',
      '            <li><a href="' + url('/cases') + '">Kundecases</a></li>',
      '            <li><a href="' + url('/priser') + '">Priser</a></li>',
      '            <li><a href="' + url('/viden/') + '">Vidensdatabase</a></li>',
      '            <li><a href="' + url('/3pl') + '">3PL &amp; Lagerhoteller</a></li>',
      '          </ul>',
      '        </div>',
      '        <div class="footer__nav-col">',
      '          <p class="footer__nav-heading">Virksomhed</p>',
      '          <ul>',
      '            <li><a href="' + url('/om-os') + '">Om os</a></li>',
      ...
      '            <li><a href="https://www.linkedin.com/company/smartpackwms" target="_blank" rel="noopener">LinkedIn</a></li>',
      '          </ul>',
      '        </div>',
      '        <div class="footer__nav-col">',
      ...
      '            <li><a href="' + url('/driftinformation') + '">Driftinformation</a></li>',
      phoneHtml,
      '          </ul>',
      '        </div>',
      '        <div class="footer__nav-col">',
      '          <p class="footer__nav-heading">Onlineværktøjer</p>',
      '          <ul>',
      '            <li><a href="' + url('/lagerdesigner/') + '">Lagerdesigner</a></li>',
      '            <li><a href="' + url('/udvidet-roi') + '">Udvidet ROI beregning</a></li>',
      '          </ul>',
      '        </div>',
      '      </div>',
      '    </div>',
      ...
      '        <a href="' + url('/vilkaar') + '">Vilk&aring;r</a> &middot; Fjernsupport:',
