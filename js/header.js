...
(function () {
  ...
  function injectHeader() {
    ...
    var html = [
      ...
      '          <a href="' + url('/udvidet-roi.html') + '" class="nav__mega-item"><strong>ROI Beregner</strong><span>Hvad sparer du med SmartPack?</span></a>',
      '        </div>',
      '      </li>',
      '      <li><a href="' + url('/priser.html') + '" class="nav__link">Priser</a></li>',
      '      <li><a href="' + url('/cases.html') + '" class="nav__link">Cases</a></li>',
      '      <li><a href="' + url('/udvidet-roi.html') + '" class="nav__link">Beregn ROI</a></li>',
      '    </ul>',
