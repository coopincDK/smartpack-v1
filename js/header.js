...
(function () {
  ...
  function injectHeader() {
    ...
    var html = [
      ...
      '          <a href="' + url('/funktioner') + '" class="nav__mega-item"><strong>Funktioner</strong><span>Alt hvad dit lager har brug for</span></a>',
      '          <a href="' + url('/onboarding') + '" class="nav__mega-item"><strong>Onboarding</strong><span>Fra aftale til live p&aring; ca. 7 dage</span></a>',
      '          <a href="' + url('/support') + '" class="nav__mega-item"><strong>Support &amp; Superbrugere</strong><span>Fri og ubegr&aelig;nset support til superbrugere</span></a>',
      '          <a href="' + url('/integrationer') + '" class="nav__mega-item"><strong>Integrationer</strong><span>Forbindelser klar til brug</span></a>',
      '          <a href="' + url('/faq') + '" class="nav__mega-item"><strong>FAQ</strong><span>Svar på de hyppigste spørgsmål</span></a>',
      '          <a href="' + url('/om-os') + '" class="nav__mega-item"><strong>Om os</strong><span>Historien bag SmartPack</span></a>',
      '          <a href="' + url('/medarbejdere') + '" class="nav__mega-item"><strong>Teamet</strong><span>Mød folkene bag systemet</span></a>',
      '          <a href="' + url('/3pl') + '" class="nav__mega-item"><strong>3PL &amp; Lagerhotel</strong><span>WMS til lagerhoteller</span></a>',
      '          <div style="grid-column:1/-1;border-top:1px solid var(--border,#e5e7eb);margin:4px 0"></div>',
      '          <a href="' + url('/lagerdesigner/') + '" class="nav__mega-item"><strong>Lagerdesigner</strong><span>Tegn dit lager gratis</span></a>',
      '          <a href="' + url('/udvidet-roi') + '" class="nav__mega-item"><strong>Udvidet ROI</strong><span>Beregn din besparelse i detaljer</span></a>',
      '        </div>',
      '      </li>',
      '      <li><a href="' + url('/priser') + '" class="nav__link">Priser</a></li>',
      '      <li><a href="' + url('/cases') + '" class="nav__link">Cases</a></li>',
      '      <li><a href="' + url('/simpel-roi') + '" class="nav__link">Beregn ROI</a></li>',
      '    </ul>',
      '    <div class="nav__actions">',
      '      <a href="https://support.smartpack.dk" target="_blank" rel="noopener" class="nav__support-link">Log ind &amp; support &rarr;</a>',
      '      <a href="' + url('/kontakt') + '" class="btn btn--ghost nav__cta nav__cta--always">Kontakt</a>',
      '      <a href="' + url('/kontakt') + '" class="btn btn--primary nav__cta">Book demo</a>',
