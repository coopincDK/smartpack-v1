---
primary_keyword: for mange systemer lager
secondary_keywords: [system integration lager, konsolidere systemer, lager software, system kompleksitet]
cluster: 02-Problemer
---

# For mange systemer – når teknologi skaber kaos i stedet for orden
...
**1. Tilføje nyt system i stedet for at erstatte**
Hver gang et system fejler, tilføjes et nyt. Snart: 8 systemer.

**2. "Vi har altid brugt det"**
Excel fra 2015. Virker stadig. Men koster 200.000 kr./år i ineffektivitet.

**3. Forskellige systemer til forskellige opgaver**
Shopify til salg, Excel til lager, Trello til opgaver. Ingen integration.

**4. Vente med konsolidering til "det er galt"**
Konsolider proaktivt. Ikke efter katastrofe.
...
**Hvor mange systemer er OK?**
2-3. Webshop + WMS + (eventuelt) regnskab. Mere = kompleksitet.

**Kan vi beholde Excel til rapportering?**
Ja. WMS eksporterer til Excel. Excel som rapporteringsværktøj er fint. Excel som operationsværktøj er risikabelt.

**Hvad med Shopify?**
Behold Shopify til webshop. Tilføj WMS til lager. Integration synkroniserer.

**Hvor lang tid tager migration?**
1-2 uger. Parallel kørsel i 1 uge. Total: 3 uger.

**Hvad hvis medarbejdere er vant til gamle systemer?**
Træning: 1-2 dage. Moderne WMS er nemmere end Excel.
